...
$pay_help_body = "<p>This screen details your unpaid entries and associated fees. If the competition organisers have designated a discount for participants with a code, you can enter the code before paying for your entries.</p>";
$pay_help_body .= "<p>For the ".$_SESSION['contestName'].", accepted payment methods are:</p>";
$pay_help_body .= "<ul>";
if ($_SESSION['prefsCash'] == "Y") $pay_help_body .= "<li><strong>Cash.</strong> Put cash in an envelope and attach to one of your bottles. Please, for the sanity of the organising staff, do not pay with coins.</li>";
