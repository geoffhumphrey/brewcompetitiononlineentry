...
if (strpos($section, "step") === FALSE) $label_character_limit = $_SESSION['prefsSpecialCharLimit']." character limit - use keywords and abbreviations if space is limited. Characters remaining: "; 
