...
if ($setup_free_access == TRUE) {
	...
	if ($action == "install-db") {
		...
		// ------------------- 
		// Styles Table (v1.3.1.0 done 05.21.15)
		// -------------------
		...
		$sql = "INSERT INTO `$system_db_table` (`id`, `version`, `version_date`, `data_check`,`setup`) VALUES (1, '1.3.1.0', '2015-05-31', NOW( ),'0');";
		mysql_select_db($database, $brewing);
		mysql_real_escape_string($sql);
		$result = mysql_query($sql, $brewing);
		 //echo "<p>".$sql."</p>";
