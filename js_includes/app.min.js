/**
 * Scripting for non-public (mostly Admin) functions. Legacy coding, etc.
 * As of version 3.0.0, public functions housed in app.pub.js.
 */
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status === "1") {
                ...
                if (admin_function == "judging_tables") {
...
function enable_competition_mode(ajax_url,admin_function) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status === "1") {
                ...
                console.log("Planning mode disabled.");
...
$(document).ready(function () {
    ...
    */
    ...
    if ((section == "brewer") || (section == "admin") || (section == "step2")) {
        ...
        if ((action == "edit") && (brewer_country == "United States") && (section == "brewer")) {
            $("#proAm").show();
            $("#ahaProAmText").show();
            $("#us-state").show();
            $("#aus-state").hide();
        ...
        if ((action == "edit") && (brewer_country == "United States") && (section == "admin")) {
            $("#proAm").show();
            $("#us-state").show();
            $("#aus-state").hide();
            $("#ca-state").hide();
        ...
        $("#brewerCountry").change(function () {
                ...
                if ($("#brewerCountry").val() == "United States") {
                    ...
                    $("#brewerProAm_2").prop("checked", false);
                }
            });
