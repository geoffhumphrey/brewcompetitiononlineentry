...
if ($db_conn->update ($update_table, $data)) $v2600_update .= "<li>BA European Origin Lagers styles updated.</li>";
	...
	$v2600_update .= "<li>BA European Origin Lagers styles NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
if ($db_conn->update ($update_table, $data)) $v2600_update .= "<li>European-Style Dark Lager style updated.</li>";
else {
	$v2600_update .= "<li>European-Style Dark Lager style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
if ($db_conn->update ($update_table, $data)) $v2600_update .= "<li>2022 BA American-Style India Pale Lager style updated.</li>";
else {
	$v2600_update .= "<li>2022 BA American-Style India Pale Lager style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
