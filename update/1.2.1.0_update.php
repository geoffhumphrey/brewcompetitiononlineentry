...
$updateSQL = "ALTER TABLE  `".$prefix."brewer_".$row_archive['archiveSuffix']."` CHANGE  `brewerAssignment`  `brewerAssignmentJudge` char(1) NULL DEFAULT NULL COMMENT  '1 for true; 0 for false', ADD  `brewerAssignmentStaff` tinyint(1) NULL DEFAULT NULL COMMENT  '1 for true; 0 for false', ADD  `brewerAssignmentSteward` tinyint(1) NULL DEFAULT NULL COMMENT  '1 for true; 0 for false' AFTER  `brewerAssignmentJudge`, ADD  `brewerAssignmentOrganizer` tinyint(1) NULL DEFAULT NULL COMMENT  '1 for true; 0 for false' AFTER  `brewerAssignmentStaff`, CHANGE  `brewerJudgeBOS`  `brewerJudgeBOS` char(1) NULL DEFAULT NULL COMMENT  '1 for true; 0 for false';";
		...
		do {
			if ($row_archive['brewerAssignmentJudge'] == "O") 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerAssgigmentJudge='0', brewerAssignmentStaff='0', brewerAssignmentSteward='0', brewerAssignmentOrganizer='1' WHERE id='%s';", $row_archive['id']);
			if ($row_archive['brewerAssignmentJudge'] == "J") 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerAssgigmentJudge='1', brewerAssignmentStaff='0', brewerAssignmentSteward='0', brewerAssignmentOrganizer='0' WHERE id='%s';", $row_archive['id']);
			if ($row_archive['brewerAssignmentJudge'] == "S") 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerAssgigmentJudge='0', brewerAssignmentStaff='0', brewerAssignmentSteward='1', brewerAssignmentOrganizer='0' WHERE id='%s';", $row_archive['id']);
			if ($row_archive['brewerAssignmentJudge'] == "X") 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerAssgigmentJudge='0', brewerAssignmentStaff='1', brewerAssignmentSteward='0', brewerAssignmentOrganizer='0' WHERE id='%s';", $row_archive['id']);
			$result = mysql_query($updateSQL, $brewing) or die(mysql_error());
			
			if ($row_archive['brewerJudgeBOS'] == "Y") 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerJudgeBOS='1' WHERE id='%s';", $row_archive['id']);
			else 
$updateSQL = sprintf("UPDATE brewer_".$row_archive['archiveSuffix']." SET brewerJudgeBOS='0' WHERE id='%s';", $row_archive['id']);
			$result = mysql_query($updateSQL, $brewing) or die(mysql_error());
