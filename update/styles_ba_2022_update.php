...
if (!check_new_style("06","182","New Zealand-Style Pale Ale")) {
	...
	$data = ['brewStyleGroup' => '06','brewStyleNum' => '182','brewStyle' => 'New Zealand-Style Pale Ale','brewStyleCategory' => 'Other Origin Ales','brewStyleVersion' => 'BA','brewStyleOG' => '1.04','brewStyleOGMax' => '1.052','brewStyleFG' => '1.006','brewStyleFGMax' => '1.01','brewStyleABV' => '4','brewStyleABVMax' => '6','brewStyleIBU' => '15','brewStyleIBUMax' => '40','brewStyleSRM' => '3','brewStyleSRMMax' => '9','brewStyleType' => '1','brewStyleInfo' => 'Overall impression is a well-integrated easy drinking, refreshing pale ale style with distinctive fruity hop aromas and flavors. Diacetyl is absent in these beers. DMS should not be present.','brewStyleLink' => 'https://www.brewersassociation.org/resources/brewers-association-beer-style-guidelines/','brewStyleActive' => 'N','brewStyleOwn' => 'bcoe','brewStyleReqSpec' => '0','brewStyleStrength' => '0','brewStyleCarb' => '0','brewStyleSweet' => '0','brewStyleTags' => '2021','brewStyleComEx' => NULL,'brewStyleEntry' => NULL];
	if ($db_conn->insert ($update_table, $data)) $v2500_update .= "<li>2021 BA style New Zealand-Style Pale Ale added.</li>";
	else {
		$v2500_update .= "<li>2021 BA style New Zealand-Style Pale Ale NOT added. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
		$error_count += 1;
	}
...
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Experimental India Pale Ale style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Experimental India Pale Ale style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Session Beer style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Session Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Session India Pale Ale style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Session India Pale Ale style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Traditional Belgian-Style Gueuze style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Traditional Belgian-Style Gueuze style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Bohemian-Style Pilsener style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Bohemian-Style Pilsener style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA American-Style India Pale Lager style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA American-Style India Pale Lager style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Specialty Beer style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Specialty Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
...
$db_conn->where ('brewStyleVersion', 'BA');
if ($db_conn->update ($update_table, $data)) $v2500_update .= "<li>2022 BA Chili Pepper Beer style updated.</li>";
else {
	$v2500_update .= "<li>2022 BA Chili Pepper Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
	$error_count += 1;
}
?>