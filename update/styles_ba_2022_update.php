...
if (!check_new_style("11","181","Kentucky Common")) {
	...
	else $output .= "<li>2021 BA style Kentucky Common NOT added. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
if (!check_new_style("06","182","New Zealand-Style Pale Ale")) {
	...
	else $output .= "<li>2021 BA style New Zealand-Style Pale Ale NOT added. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
if (!check_new_style("06","183","New Zealand-Style India Pale Ale")) {
	...
	else $output .= "<li>2021 BA style New Zealand-Style India Pale Ale NOT added. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
if (!check_new_style("05","184","Belgian-Style Session Ale")) {
	...
	else $output .= "<li>2021 BA style Belgian-Style Session Ale NOT added. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Experimental India Pale Ale style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Session Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Session India Pale Ale style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Traditional Belgian-Style Gueuze style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Bohemian-Style Pilsener style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA American-Style India Pale Lager style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Specialty Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
...
else $output .= "<li>2022 BA Chili Pepper Beer style NOT updated. <strong class=\"text-warning\">Error: ".$db_conn->getLastError()."</strong></li>";
?>