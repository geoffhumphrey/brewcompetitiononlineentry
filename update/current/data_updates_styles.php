...
do { 
	...
	if ($row_styles['style_cat'] > 28) {
		...
		echo "<ul><li>Custom style ".$row_styles['style_name']." moved to styles_custom table successfully.</li></ul>";
...
echo "<ul><li>Conversion of styles and associated tables completed.</li></ul>";
