...
<p class="hidden-print"><?php if ($row_styles['brewStyleLink'] != "") { ?><a class="hide-loader" href="<?php echo $row_styles['brewStyleLink']; ?>" target="_blank"><?php echo $label_more_info; ?></a><?php echo " - ".$output_text_027; } else echo "&nbsp;"; ?></p>
