...
if (isset($_SESSION['loginUsername'])) {
    ...
    if (($_SESSION['prefsEntryForm'] == "6") || ($_SESSION['prefsEntryForm'] == "8") || ($_SESSION['prefsEntryForm'] == "9")) $anon = TRUE;
    if (($_SESSION['prefsEntryForm'] == "5") || ($_SESSION['prefsEntryForm'] == "6")) $barcode_qr = TRUE;
    if ($_SESSION['prefsEntryForm'] == "9") $large_entry_num = TRUE;
      ...
      if ((($id == "default") && (in_array($row_log['id'], $entry_arr))) || (($id != "default") && ($row_log['id'] == $id))) {
        ...
        for ($i=1; $i<=$bottle_label_count; $i++) {
          ...
          $barcode = sprintf("%06s",$row_log['id']);
            ...
            if ($large_entry_num) {
              // Large Entry Number label: big number, style, entry name, and description
              $page_info1 .= "<p class=\"text-center label-title\"><strong>".$_SESSION['contestName']."</strong></p>";
              $page_info1 .= "<p class=\"text-center label-entry-num\">".$barcode."</p>";
              $page_info1 .= "<p>";
              if ($_SESSION['prefsStyleSet'] == "BA") $page_info1 .= "<strong>Cat: ".$row_log['brewStyle']."</strong><br>";
