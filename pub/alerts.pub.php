...
var x = setInterval(function() {
  ...
  document.getElementById("alert-countdown").innerHTML = seconds;
    
  // If the count down is over, write some text 
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("alert-countdown").innerHTML = "";
    document.getElementById("alert-closing").innerHTML = "Closing...";
  }
}, 1000);
</script>
...
<script type="text/javascript">
  new AvalynxAlert('<?php // echo $alert_text_061; ?>', 'warning', {
    duration: 5000,
    position: 'top-right',
    closeable: true,
    autoClose: true,
