    ...
    <?php if ($go == "scoresheet") { ?>
      ...
      setInterval(function() {
        ...
        if ((elapsedTime > 600) && (elapsedTime < 900)) {
          $("#elapsed-time-p").attr("class", "text-warning-emphasis");
          $("#warning-indicator-icon").attr("class", "fa fa-lg fa-exclamation-triangle text-warning-emphasis mt-2 mb-2 me-1");
          $("#warning-indicator-icon").show();
          $("#session-end-eval-p").attr("class", "text-warning-emphasis");
        }
        
        if (elapsedTime >= 900) {
          $("#elapsed-time-p").attr("class", "text-danger-emphasis");
          $("#courtesy-alert-warning-15").show();
          $("#courtesy-alert-warning-15").attr("class", "text-danger-emphasis");
          $("#warning-indicator-icon").attr("class", "fa fa-lg fa-beat-fade fa-exclamation-triangle text-danger-emphasis mt-2 mb-2 me-1");
          $("#warning-indicator-icon").show();
          $("#session-end-eval-p").attr("class", "text-danger-emphasis");
        }
      }, 1);
