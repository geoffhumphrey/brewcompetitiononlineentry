...
if ((isset($_SESSION['prefsProEdition'])) && ($_SESSION['prefsProEdition'] == 0)) {
	if (HOSTED) $footer .= $current_version_display."<span class=\"d-none d-lg-inline\"> &ndash; ".$label_hosted." ".$label_amateur_comp_edition."</span>";
	else $footer .= $current_version_display."<span class=\"d-none d-lg-inline\"> &ndash; ".$label_amateur_comp_edition."</span>";
}

elseif ((isset($_SESSION['prefsProEdition'])) && ($_SESSION['prefsProEdition'] == 1)) {
	if (HOSTED) $footer .= $current_version_display."<span class=\"d-none d-lg-inline\"> &ndash; ".$label_hosted." ".$label_pro_comp_edition."</span>";
	else $footer .= $current_version_display."<span class=\"d-none d-lg-inline\"> &ndash; ".$label_pro_comp_edition."</span>";
}
