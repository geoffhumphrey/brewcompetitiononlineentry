...
if ($totalRows_log_paid >= $row_limits['prefsEntryLimit']) echo "<div class='error'>The limit of paid entries has been reached. The payment system is no longer active.</div>";
	...
	*/
	...
	if (($_SESSION['prefsPayToPrint'] == "Y") && ($unconfirmed > 0)) echo "<div class='error'>You cannot pay for your entries because one or more of your entries is unconfirmed.</div><p>Click &ldquo;My Account&rdquo; above to review your unconfirmed entries.</p>"; 
		...
		if ($total_entry_fees > 0) { 
			...
			echo '<p><span class="icon"><img src="<?php echo $base_url; ?>images/help.png"  /></span><a id="modal_window_link" href="http://help.brewcompetition.com/files/pay_my_fees.html" title="BCOE&amp;M Help: Pay My Entry Fees">Pay My Entry Fees Help</a></p>';
		}
