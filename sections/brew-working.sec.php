...
<p>The more complete you are here, the more information will be reflected on your required entry forms (generated by clicking the printer icon from your <a href="<?php echo build_public_url("list","default","default","default",$sef,$base_url); ?>">list of entries</a>).</p>
<?php if (($action == "add") && ($_SESSION['prefsHideRecipe'] == "N") && ($remaining_entries > 0)) { ?>
<p><span class="icon"><img src="<?php echo $base_url; ?>images/page_code.png"  /></span>You can also <a href="<?php echo build_public_url("beerxml","default","default","default",$sef,$base_url); ?>">import your entry's BeerXML document</a>.</p>
<?php } } ?>
<script>
	$(function() {
