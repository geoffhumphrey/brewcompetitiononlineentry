...
<p>There were <strong><?php echo get_entry_count(); ?></strong> entries and <strong><?php echo get_participant_count('default'); ?></strong> registered participants, judges, and stewards.</p>