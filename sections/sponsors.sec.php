...
do {
	...
	if (($sponsors_endRow == 0) && ($sponsors_hloopRow1++ != 0)) $page_info1 .= "<div class='row'>";
	
	// Layout Column DIV
	$page_info1 .= "<div class='col-lg-3 col-md-6 col-sm-9 col-xs-12'>";
	
	// Sponsor Name
	$page_info1 .= "<div class='bcoem-sponsor-name'>";
	$page_info1 .= "<h5>";
	...
	// Sponsor Location
	if ($row_sponsors['sponsorLocation'] != "") $page_info1 .= "<div class='bcoem-sponsor-location'>".$row_sponsors['sponsorLocation']."</div>";
	else $page_info1 .= "<div class='bcoem-sponsor-location'>&nbsp;</div>"; // provides uniformity in display
	...
	// Sponsor Info
	if ($row_sponsors['sponsorText'] != "") $page_info1 .= "<div class='bcoem-sponsor-text small'>".$row_sponsors['sponsorText']."</div>";
	
	// END Layout Column DIV
	$page_info1 .= "</div>";
