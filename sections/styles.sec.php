...
if ($filter != "default") $query_styles = "SELECT * FROM styles WHERE brewStyleGroup='$filter' ORDER BY brewStyleGroup,brewStyleNum";
else $query_styles = "SELECT * FROM styles ORDER BY brewStyleGroup,brewStyleNum";
...
<div id="content">
	<div id="content-inner-no-nav">
    	<div id="header">
        	<div id="header-inner"><h1>BJCP Styles</h1></div>
        </div>
    <table>
	<tr>
	...
	<?php
						  ...
						  elseif ($row_styles['brewStyleSRM'] != "") 
						  	...
						  	$SRMmax = ltrim ($row_styles['brewStyleSRMMax'], "0"); 
						  		echo "<table width=\"60%\"><tr><td width=\"48%\"><table class=\"colorTable\"><tr><td bgcolor=".$beercolorMin.">"; 
						  		if ($SRMmin > "15") echo "<font color=\"#ffffff\">"; 
								else echo "<font color=\"#000000\">"; 
								echo $SRMmin."</font></td></tr></table></td><td width=\"4%\">&nbsp;&ndash;&nbsp;</td><td width=\"48%\"><table class=\"colorTable\"><tr><td bgcolor=".$beercolorMax.">"; 
								if ($SRMmax > "15") echo "<font color=\"#ffffff\">"; 
								else echo "<font color=\"#000000\">"; 
								echo $SRMmax."</font></td></tr></table></td></tr></table>"; 
							}
						   else { echo "&nbsp;"; }
						  ?>       </td>
   </tr>
...
<table>
   <tr>
    <td class="data-left"><a href="<?php echo $row_styles['brewStyleLink']; ?>" target="_blank">More Info</a> (link to Beer Judge Certification Program Style Guidelines)</td>
   </tr>
  </table>
<?php } 
