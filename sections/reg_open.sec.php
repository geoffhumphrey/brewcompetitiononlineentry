...
if (($registration_open == "1") && (!isset($_SESSION['loginUsername']))) { 
	...
	$page_info1 .= "<p>If you <em>have</em> registered, <a href='".build_public_url("login","default","default","default",$sef,$base_url)."'>log in</a> and then choose <em>Edit Account</em> to indicate that you are willing to judge or  steward.</p>";
}
