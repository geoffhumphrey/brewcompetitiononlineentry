<div id="header">	
	<div id="header-inner"><h1><?php if ($action == "add") echo "Step 3: Add Your Entry"; else echo "Edit Your Entry"; ?></h1></div>
</div>
<?php 
if ($msg == "2") echo "<div class=\"error\">Your personal information has been added.</div>"; 
...
<tr>
   ...
   <select name="brewBrewerID">
    <?php do { 
    $query_user1 = sprintf("SELECT id FROM users WHERE user_name = '%s'", $row_brewers['brewerEmail']);
	$user1 = mysql_query($query_user1, $brewing) or die(mysql_error());
	$row_user1 = mysql_fetch_assoc($user1);
     ?>
   	<option value="<?php echo $row_user1['id']."-".$row_brewers['brewerLastName']."-".$row_brewers['brewerFirstName']; ?>" <?php if (($action == "edit") && ($row_log['brewBrewerID'] == $row_user1['id'])) echo "SELECTED";  if (($action == "add") && ($_SESSION['loginUserName'] == $row_brewers['user_name'])) echo "SELECTED"; ?>><?php echo $row_brewers['brewerLastName'].", ".$row_brewers['brewerFirstName']; ?></option>
...
<tr>
   ...
   <td class="data"><span class="required">Required</span><span class="data"><img src="images/information.png" align="absmiddle" />&nbsp;<a class="thickbox" href="sections/styles.sec.php?KeepThis=true&TB_iframe=true&height=425&width=700">View Styles</a></span></td>
</tr>
<tr>
...
<tr>
   ...
   <td class="data"><input name="brewHops1Weight" type="text" id="brewHops1Weight" size="1" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if ($action == "edit") echo $row_log['brewHops1Weight']; if ($action == "importCalc") echo $brewHops1Weight; ?>">&nbsp;oz.</td>
     <td class="data"><input name="brewHops1IBU" type="text" id="brewHops1IBU" size="1" tooltipText="<?php echo $toolTip_decimal; ?>" value="<?php if ($action == "edit") echo $row_log['brewHops1IBU']; if ($action == "importCalc") echo $brewHops1IBU; ?>">&nbsp;%</td>
     <td class="data"><input type="text" name="brewHops1Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops1Time'];  if ($action == "importCalc") echo $brewHops1Time; ?>">&nbsp;min.</td>
  ...
  <tr>
   ...
   <td class="data"><input name="brewHops2Weight" type="text" id="brewHops2Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops2Weight']; if ($action == "importCalc") echo $brewHops2Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops2IBU" type="text" id="brewHops2IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops2IBU']; if ($action == "importCalc") echo $brewHops2IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops2Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops2Time']; if ($action == "importCalc") echo $brewHops2Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops3Weight" type="text" id="brewHops3Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops3Weight']; if ($action == "importCalc") echo $brewHops3Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops3IBU" type="text" id="brewHops3IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops3IBU']; if ($action == "importCalc") echo $brewHops3IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops3Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops3Time']; if ($action == "importCalc") echo $brewHops3Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops4Weight" type="text" id="brewHops4Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops4Weight']; if ($action == "importCalc") echo $brewHops4Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops4IBU" type="text" id="brewHops4IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops4IBU']; if ($action == "importCalc") echo $brewHops4IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops4Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops4Time']; if ($action == "importCalc") echo $brewHops4Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops5Weight" type="text" id="brewHops5Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops5Weight']; if ($action == "importCalc") echo $brewHops5Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops5IBU" type="text" id="brewHops5IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops5IBU']; if ($action == "importCalc") echo $brewHops5IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops5Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops5Time']; if ($action == "importCalc") echo $brewHops5Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops6Weight" type="text" id="brewHops6Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops6Weight']; if ($action == "importCalc") echo $brewHops6Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops6IBU" type="text" id="brewHops6IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops6IBU']; if ($action == "importCalc") echo $brewHops6IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops6Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops6Time']; if ($action == "importCalc") echo $brewHops6Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops7Weight" type="text" id="brewHops7Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops7Weight']; if ($action == "importCalc") echo $brewHops7Weight; ?>">&nbsp;oz.</td>
     <td class="data"><input name="brewHops7IBU" type="text" id="brewHops7IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops7IBU']; if ($action == "importCalc") echo $brewHops7IBU; ?>">&nbsp;%</td>
     <td class="data"><input type="text" name="brewHops7Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops7Time']; if ($action == "importCalc") echo $brewHops7Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops8Weight" type="text" id="brewHops8Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops8Weight']; if ($action == "importCalc") echo $brewHops8Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops8IBU" type="text" id="brewHops8IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops8IBU']; if ($action == "importCalc") echo $brewHops8IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops8Time" size="1"  value="<?php if ($action == "edit") echo $row_log['brewHops8Time']; if ($action == "importCalc") echo $brewHops8Time; ?>">&nbsp;min.</td>
...
<tr>
   ...
   <td class="data"><input name="brewHops9Weight" type="text" id="brewHops9Weight" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops9Weight']; if ($action == "importCalc") echo $brewHops9Weight; ?>">&nbsp;oz.</td>
   <td class="data"><input name="brewHops9IBU" type="text" id="brewHops9IBU" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops9IBU']; if ($action == "importCalc") echo $brewHops9IBU; ?>">&nbsp;%</td>
   <td class="data"><input type="text" name="brewHops9Time" size="1" value="<?php if ($action == "edit") echo $row_log['brewHops9Time']; if ($action == "importCalc") echo $brewHops9Time; ?>">&nbsp;min.</td>
