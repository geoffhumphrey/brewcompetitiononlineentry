...
<tr>
   ...
   <select name="brewBrewerID">
	...
	$row_user1 = mysql_fetch_assoc($user1);
     ?>
   	<option value="<?php echo $row_user1['id']."-".$row_brewers['brewerLastName']."-".$row_brewers['brewerFirstName']; ?>" <?php if (($action == "add") && ($filter == $row_user1['id'])) echo "SELECTED"; elseif (($action == "edit") && ($row_log['brewBrewerID'] == $row_user1['id'])) echo "SELECTED";  elseif ((($action == "add") && ($filter == "default")) && ($_SESSION['loginUserName'] == $row_brewers['user_name'])) echo "SELECTED"; ?>><?php echo $row_brewers['brewerLastName'].", ".$row_brewers['brewerFirstName']; ?></option>
