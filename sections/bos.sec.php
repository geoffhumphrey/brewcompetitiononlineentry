...
<table class="dataTable">
 ...
 <?php do { 
	...
	?>
 <tr <?php echo " style=\"background-color:$color\"";?>>
  <td class="dataList" nowrap="nowrap"><span class="icon"><img src="images/<?php if ($row_bos3['brewBOSPlace'] == "1") echo "medal_gold_3"; elseif ($row_bos3['brewBOSPlace'] == "2") echo "medal_silver_3"; elseif ($row_bos3['brewBOSPlace'] == "3") echo "medal_bronze_3"; else echo "thumb_up"; ?>.png" align="absmiddle" /></span><?php echo $row_bos3['brewBOSPlace']; ?></td>
...
<table class="dataTable">
 ...
 <?php do { 
	...
	?>
 <tr <?php echo " style=\"background-color:$color\"";?>>
  <td class="dataList" nowrap="nowrap"><span class="icon"><img src="images/<?php if ($row_bos2['brewBOSPlace'] == "1") echo "medal_gold_3"; elseif ($row_bos2['brewBOSPlace'] == "2") echo "medal_silver_3"; elseif ($row_bos2['brewBOSPlace'] == "3") echo "medal_bronze_3"; else echo "thumb_up"; ?>.png" align="absmiddle" /></span><?php echo $row_bos2['brewBOSPlace']; ?></td>
