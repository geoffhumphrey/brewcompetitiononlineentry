...
<table>
  ...
  <tr>
    ...
    <td><span class="error">If any items are missing, close this window and click the pencil icon to edit the entry.</span></td>

    <td width="5%" align="right" nowrap="nowrap"><img src = "../images/printer.png"  />&nbsp;<a href="?action=print&amp;id=<?php echo $id; ?>">Print</a></td>
  ...
  <tr>
    ...
    <table class="small">
      ...
      <tr>
        ...
        <td align="left" valign="top" class="headerItalic bdr1B bdr1L bdr1R"><em>USE (MASH/STEEP)</td>
...
<?php if ($action != "print") { ?><p align="right"><img src = "../images/printer.png"  />&nbsp;<a href="?action=print&amp;id=<?php echo $id; ?>">Print</a></p><?php } ?>
