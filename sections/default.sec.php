...
if (($judging_past == 0) && ($registration_open == 2) && ($entry_window_open == 2)) {
	...
	if ($style_types_active > 0) {
		...
		if ($bos_data_available) {
			if ($filter == "default") $header1_10 .= sprintf(" <a class=\"hide-loader\" href=\"%soutput/export.output.php?section=results&amp;go=judging_scores_bos&amp;action=download&amp;filter=default&amp;view=pdf\" data-toggle=\"tooltip\" title=\"%s\" target=\"_blank\"><span class=\"fa fa-file-pdf-o hidden-print\"></span></a> <a class=\"hide-loader\" href=\"%soutput/export.output.php?section=results&amp;go=judging_scores_bos&amp;action=download&amp;filter=default&amp;view=html\" data-toggle=\"tooltip\" title=\"%s\" target=\"_blank\"><span class=\"fa fa-file-code-o hidden-print\"></span></a>",$base_url,$default_page_text_018,$base_url,$default_page_text_019);
		}
	...
	if ($filter == "default") $header1_20 .= sprintf(" <a class=\"hide-loader\" href=\"%soutput/export.output.php?section=results&amp;go=judging_scores&amp;action=default&amp;filter=default&amp;view=pdf\" data-toggle=\"tooltip\" title=\"%s\" target=\"_blank\"><span class=\"fa fa-file-pdf-o hidden-print\"></span></a> <a class=\"hide-loader\" href=\"%soutput/export.output.php?section=results&amp;go=judging_scores&amp;action=default&amp;filter=default&amp;view=html\" data-toggle=\"tooltip\" title=\"%s\" target=\"_blank\"><span class=\"fa fa-file-code-o hidden-print\"></span></a>",$base_url,$default_page_text_020,$base_url,$default_page_text_021);
	$header1_20 .= "</h2>";
