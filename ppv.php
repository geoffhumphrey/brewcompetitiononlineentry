 ...
 * @link http://www.evoluted.net/thinktank/web-development/paypal-php-integration
 * 
 * To implement:
 * 
 ...
 * 
 * Users will need to enable Instant Payment Notification (IPN)
 *	-- Must have a business account
 *	-- Login > Profile > My Selling Tools > Instant payment notifications
 *	-- Notification URL should be $base_url."ppv.php";
 * 
 * Users must also have PayPal Instant Payment Notifications enabled in their BCOE&M installation
 *	-- Admin > Preferences > Payment Preferences
 */
