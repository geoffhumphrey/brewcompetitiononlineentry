...
if ($action == "edit") {
  ...
  if ($id == "default") $db_conn->where('evalToken', $token);
  else $db_conn->where('id', $id);
...
if ($style_query_pending) {
  $row_style = $db_conn->getOne($prefix."styles");
...
if ($entry_found) {
  ...
  if (empty($style_link)) {
    ...
    if ($_SESSION['style_set_no_numbering']) $entry_info_html .= "<a style=\"margin-left:10px;\" href=\"https://www.brewersassociation.org/edu/brewers-association-beer-style-guidelines/\" target=\"_blank\"><i class=\"small fa fa-external-link\"></i></a>";
  ...
  if ((!empty($row_entry_info['brewMead1'])) || (in_array("carb",$missing_mead_info))) {
    ...
    if (!empty($row_entry_info['brewMead1'])) $entry_info_html .= "<div class=\"col col-lg-9 col-md-8 col-sm-8 col-xs-12\">".$row_entry_info['brewMead1']."</div>";
  ...
  if ((!empty($row_entry_info['brewMead3'])) || (in_array("strength",$missing_mead_info))) {
    ...
    if (!empty($row_entry_info['brewMead3'])) $entry_info_html .= "<div class=\"col col-lg-9 col-md-8 col-sm-8 col-xs-12\">".$row_entry_info['brewMead3']."</div>";
    else $entry_info_html .= "<div class=\"col col-lg-9 col-md-8 col-sm-8 col-xs-12\"><span class=\"text-danger\"><i class=\"fa fa-exclamation-triangle\"></i> ".$label_mead_info_not_recorded."</span></div>";
    $entry_info_html .= "</div>";
  }
  ...
  if ((!empty($row_entry_info['brewMead2'])) || (in_array("sweet",$missing_mead_info))) {
    ...
    if (!empty($row_entry_info['brewMead2'])) $entry_info_html .= "<div class=\"col col-lg-9 col-md-8 col-sm-8 col-xs-12\">".$row_entry_info['brewMead2']."</div>";
    else $entry_info_html .= "<div class=\"col col-lg-9 col-md-8 col-sm-8 col-xs-12\"><span class=\"text-danger\"><i class=\"fa fa-exclamation-triangle\"></i> ".$label_mead_info_not_recorded."</span></div>";
    $entry_info_html .= "</div>";
  }
