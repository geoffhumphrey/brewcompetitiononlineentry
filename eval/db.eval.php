...
$query_judge = sprintf("SELECT brewerFirstName,brewerLastName,brewerJudgeID,brewerJudgeRank,brewerEmail FROM %s WHERE uid=%s", $prefix."brewer".$archive_suffix, $row_eval['evalJudgeInfo']);
