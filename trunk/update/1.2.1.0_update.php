...
echo "<h2>Performing Updates for Version 1.2.1.0, 1.2.1.1, 1.2.1.2, and 1.2.1.3...</h2>";
...
// Update Preferences to use new date/time schema
	...
	if ($_SESSION['contestRegistrationOpen'] != "") $string1 = strtotime($_SESSION['contestRegistrationOpen']."08:00 AM");

	else $string1 = strtotime(date("Y-m-d")."08:00 AM");

	

	if ($_SESSION['contestRegistrationDeadline'] != "") $string2 = strtotime($_SESSION['contestRegistrationDeadline']."08:00 PM");

	else $string2 = strtotime(date("Y-m-d")."08:00 PM");

	

	if ($_SESSION['contestEntryOpen'] != "") $string3 = strtotime($_SESSION['contestEntryOpen']."08:00 AM");

	else $string3 = strtotime(date("Y-m-d")."08:00 PM");

	

	if ($_SESSION['contestEntryDeadline'] != "") $string4 = strtotime($_SESSION['contestEntryDeadline']."08:00 PM");

	else $string4 = strtotime(date("Y-m-d")."08:00 PM");

	

	if ($_SESSION['contestAwardsLocDate'] != "") $string5 = strtotime($_SESSION['contestAwardsLocDate'].$_SESSION['contestAwardsLocTime']);
