...
<div class="adminSubNavContainer">
	<span class="adminSubNav">
    	<span class="icon"><img src="images/note.png"  /></span><a href="index.php?section=admin&amp;go=styles">View Accepted Styles</a>
    </span>
	<span class="adminSubNav">
    ...
    <span class="adminSubNav">
    	<span class="icon"><img src="images/page.png"  /></span><a href="index.php?section=admin&amp;go=style_types">View Style Types</a>
    </span>
    <span class="adminSubNav">
...
<tbody>
	<?php do {
	$query_entries_1 = sprintf("SELECT brewStyle,brewCategorySort,brewCategory,brewSubCategory FROM brewing WHERE id='%s'", $row_bos['eid']);
	...
	$query_bos_place_1 = sprintf("SELECT scorePlace,scoreEntry FROM judging_scores_bos WHERE eid='%s'", $row_bos['eid']);
