...
<table class="dataTable">
  ...
  <tr <?php echo " style=\"background-color:$color\"";?>>
    ...
    <td class="dataList" width="10%" nowrap="nowrap"><span class="icon"><img src="images/tick.png" align="absmiddle" border="0"></span><?php echo $row_archive['archiveSuffix']; ?></td>
    <td class="dataList" width="10%" nowrap="nowrap"><span class="icon"><img src="images/monitor.png" align="absmiddle" border="0"></span><a href="index.php?section=admin&go=participants&dbTable=<?php echo $row_archive['archiveBrewerTableName']; ?>"><?php echo $row_archive['archiveSuffix']; ?></a></td>
    <td class="dataList" width="10%" nowrap="nowrap"><span class="icon"><img src="images/monitor.png" align="absmiddle" border="0"></span><a href="index.php?section=admin&go=entries&dbTable=<?php echo $row_archive['archiveBrewingTableName']; ?>"><?php echo $row_archive['archiveSuffix']; ?></a></td>
