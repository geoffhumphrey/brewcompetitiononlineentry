...
<table>
  ...
  <tr>
    ...
    <select name="tableNumber" id="tableNumber">
    	...
    	<option value="<?php echo $i; ?>" <?php if (in_array($i,$a)) echo "disabled"; ?>><?php echo $i; ?></option>
...
<form method="post" action="<?php echo $base_url; ?>includes/process.inc.php?section=<?php echo $section; ?>&amp;action=<?php echo $action; ?>&amp;dbTable=<?php echo $judging_tables_db_table; ?>&amp;go=<?php echo $go."&amp;id=".$id; ?>" name="form1" id="form1" onSubmit="return CheckRequiredFields()">
