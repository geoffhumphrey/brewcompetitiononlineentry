...
switch($section) {
	...
	if ($action == "add") $header_output = "Add an Entry"; 
		...
		switch ($msg) {
			...
			case "1-27-B":
			case "1-27-C": 
			case "1-27-D": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MAY specify variety of apple for a single varietal cider; if specified, varietal character will be expected.<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
			case "1-27-E": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). Variety of pear(s) used MUST be stated.<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
			case "1-28-A": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MUST specify if the cider was barrel-fermented or aged.<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
			case "1-28-B": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MUST specify what fruit(s) and/or fruit juice(s) were added.<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
			case "1-28-C": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet).<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
			case "1-28-D": $output = "See the area(s) highlighted in RED below. You MUST specify all major ingredients and adjuncts. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet).<br /> If you do not specify the items above, your entery cannot be confirmed. "; break;
