<div id="header">	
	<div id="header-inner"><h1><?php if ($action == "forgot") echo "Reset Password"; elseif ($action == "logout") echo "Logged Out"; else echo "Log In"; ?></h1></div>
</div>
...
<?php } 
if ($msg == "3") { ?>
<div class="error">You have been logged out. Log in again?</div>
<?php }	?>
