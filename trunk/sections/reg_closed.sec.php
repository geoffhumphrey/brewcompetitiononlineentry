...
<p>There are <strong><?php echo $totalRows_log; ?></strong> entries (<strong><?php echo get_entry_count('paid-received'); ?></strong> paid and received) from <strong><?php echo get_participant_count('default'); ?></strong> registered participants, judges, and stewards.</p>
