...
if ($setup_free_access == TRUE) {
	...
	if ($action == "install-db") {
		...
		CREATE TABLE IF NOT EXISTS `$drop_off_db_table` (
		  `id` int(8) NOT NULL AUTO_INCREMENT,
		  `dropLocation` text,
		  `dropLocationName` varchar(255) NULL DEFAULT NULL,
		  `dropLocationPhone` varchar(255) NULL DEFAULT NULL,
		...
		CREATE TABLE IF NOT EXISTS `$judging_flights_db_table` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `flightTable` int(11) NULL DEFAULT NULL COMMENT 'id of Table from tables',
		...
		CREATE TABLE IF NOT EXISTS `$judging_tables_db_table` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `tableName` varchar(255) NULL DEFAULT NULL COMMENT 'Name of table that will judge the prescribed categories',
		  `tableStyles` text COMMENT 'Array of ids from styles table',
		  `tableNumber` int(11) NULL DEFAULT NULL COMMENT 'User defined for sorting',
		  `tableLocation` int(11) NULL DEFAULT NULL COMMENT 'Physical location of table (if more than one judging location) - relational to judging table',
		...
		CREATE TABLE IF NOT EXISTS `$special_best_data_db_table` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `sid` int(11) NULL DEFAULT NULL COMMENT 'relational to special_best_info table',
		  `bid` int(11) NULL DEFAULT NULL COMMENT 'relational to brewer table - bid row',
		  `eid` int(11) NULL DEFAULT NULL COMMENT 'relational to brewing table - id (entry number)',
		...
		CREATE TABLE IF NOT EXISTS `$special_best_info_db_table` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `sbi_name` varchar(255) NULL DEFAULT NULL,
		  `sbi_description` text,
		  `sbi_places` int(11) NULL DEFAULT NULL,
		...
		CREATE TABLE IF NOT EXISTS `$sponsors_db_table` (
		  `id` int(8) NOT NULL AUTO_INCREMENT,
		  `sponsorName` varchar(255) NULL DEFAULT NULL,
		  `sponsorURL` varchar(255) NULL DEFAULT NULL,
		  `sponsorImage` varchar(255) NULL DEFAULT NULL,
		  `sponsorText` text,
		...
		CREATE TABLE IF NOT EXISTS `$style_types_db_table` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  `styleTypeName` varchar(255) NULL DEFAULT NULL,
		  `styleTypeOwn` varchar(255) NULL DEFAULT NULL,
		...
		$sql = "INSERT INTO `$system_db_table` (`id`, `version`, `version_date`, `data_check`,`setup`) VALUES (1, '1.3.0.4', '2012-10-025', NOW( ),'0');";
		mysql_select_db($database, $brewing);
		mysql_real_escape_string($sql);
		$result = mysql_query($sql, $brewing);
		 //echo "<p>".$sql."</p>";
		...
		CREATE TABLE IF NOT EXISTS `$users_db_table` (
		  ...
		  `userLevel` char(1) NULL DEFAULT NULL,
		  `userQuestion` varchar(255) NULL DEFAULT NULL,
		...
		if (HOSTED) {
			$password = "d9efb18ba2bc4a434ddf85013dbe58f8";
