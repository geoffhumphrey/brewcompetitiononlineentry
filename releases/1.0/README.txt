...
3. Access your new database and import the database schema. The database schema is contained within the bcoe1.0.sql document. Typically, you can import the entire document using PhpMyAdmin.

4. Edit the username, password, and database variables the config.php file located in the contest/Connections/ directory. 

5. Upload the entire contents of the "competition" folder to your webserver via FTP or other method (upload only the *contents* of the folder, not the folder itself).
