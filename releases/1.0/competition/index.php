...
<div id="content">
	...
	mysql_select_db($database, $brewing);
	$query_log = "SELECT * FROM brewing ORDER BY brewSubCategory, brewName, brewBrewerLastName ASC";
	$log = mysql_query($query_log, $brewing) or die(mysql_error());
	$row_log = mysql_fetch_assoc($log);
	$totalRows_log = mysql_num_rows($log);
	echo "<div id=\"header\"><div id=\"header-inner\"><h1>Registration Closed</h1></div></div><div class=\"error\">Registration has closed for the ".$row_contest_info['contestName']." contest.</div>";
...
<div id="footer">
	<div id="footer-inner">Brew Competition Online Entry (BCOE) <?php include ('includes/version.inc.php'); ?> &copy;<?php if (date ('Y') == "2009") echo date('Y'); else echo "2009-".date('Y'); ?> Geoff Humphrey for <a href="http://www.zkdigital.com" target="_blank">zkdigital.com</a>.</div>
</div>
</div>
</body>
</html>
