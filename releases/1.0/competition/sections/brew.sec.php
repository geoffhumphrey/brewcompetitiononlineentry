...
<input type="hidden" name="brewBrewerFirstName" value="<?php echo $row_log['brewBrewerFirstName']; ?>">
<input type="hidden" name="brewBrewerLastName" value="<?php echo $row_log['brewBrewerLastName']; ?>">
