	...
	function startElement($parser,$tagName,$attrs) {
		...
		switch($tagName){
			...
			case "MASH":
				...
				$this->mash = $mash;
				break;
            case "WATERS": // beerXML SPEC DOES NOT INCLUDE A WATERS TAG, ONLY WATER...BEERSMITH IS IMPLEMENTING INCORRECTLY
				$waters = new Waters();
				$waters->parse($parser,$this);
				$this->waters = $waters;
				break;
            case "MISCS":
				$miscs = new Miscs();
