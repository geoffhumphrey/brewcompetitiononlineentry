...
<?php
    ...
    ?>
  	<td>
  	<?php echo $row_styles['style_cat']." ".$row_styles['style_subcat']." ".$row_styles['style_name']; ?>
  	</td>
    <?php  
		$styles_endRow++;
	...
	?>
    <tr>
    <td colspan="3"><strong>Custom Styles</strong></td>
    </tr>
    <tr>
<?php
	$styles_endRow = 0;
    ...
    ?>
  	<td>
  	<?php echo $row_styles_custom['style_cat']." ".$row_styles_custom['style_subcat']." ".$row_styles_custom['style_name']; ?>
  	</td>
    <?php  
		$styles_endRow++;
		if ($styles_endRow >= $styles_columns) { $styles_endRow = 0; }
