...
<script type="text/javascript" language="javascript" src="http://ajax.microsoft.com/ajax/jquery.validate/1.7/jquery.validate.js"></script>
<?php 
if (($action != "print") && ($msg != "default")) echo $msg_output; 
if (($action == "add") || (($action == "edit") && (($row_user['id'] == $row_log['brewBrewerID']) || ($row_user['userLevel'] == 1)))) {
	if ($filter == "default") { ?>
<p><span class="icon"><img src="images/help.png"  /></span><a id="modal_window_link" href="http://help.brewcompetition.com/files/add_edit_entries.html" title="BCOE&amp;M Help: Add/Edit an Entry">Add/Edit an Entry Help</a></p>
<p>The more complete you are here, the more information will be reflected on your required entry forms (generated by clicking the printer icon from your <a href="index.php?section=list">list of entries</a>).</p>
<?php if ($action == "add") { ?>
...
<tr>
   ...
   <select name="brewBrewerID">
    <?php do { ?>
   	<option value="<?php echo $row_brewers['uid']; ?>" <?php if (($action == "add") && ($filter == $row_brewers['uid'])) echo "SELECTED"; elseif (($action == "edit") && ($row_log['brewBrewerID'] == $row_brewers['uid'])) echo "SELECTED";  elseif (($action == "add") && ($row_user['id'] == $row_brewers['uid'])) echo "SELECTED"; ?>><?php echo $row_brewers['brewerLastName'].", ".$row_brewers['brewerFirstName']; ?></option>
...
<tr>
   ...
   <select name="brewStyle">
   	 <option value=""></option>
     <optgroup label="Main Style Set: <?php echo $row_styles_active['style_name']." ".$row_styles_active['style_year']; ?>">
    <?php do {  ?>
     <option value="<?php echo $row_styles['id']; ?>-M" <?php if ($action == "edit")  if ($row_styles['id'] == $row_log['brewStyle']) echo "SELECTED"; ?>><?php echo $row_styles['style_cat']." ".$row_styles['style_subcat']." - ".$row_styles['style_name']; ?></option>
    <?php } while ($row_styles = mysql_fetch_assoc($styles)); ?>
    </optgroup>
    <optgroup label="Custom Styles">
    <?php do {  ?>
     <option value="<?php echo $row_styles_custom['id']; ?>-C" <?php if ($action == "edit")  if ($row_styles_custom['id'] == $row_log['brewStyle']) echo "SELECTED"; ?>><?php echo $row_styles_custom['style_cat']." ".$row_styles_custom['style_subcat']." - ".$row_styles_custom['style_name']; ?></option>
    <?php } while ($row_styles_custom = mysql_fetch_assoc($styles_custom)); ?>
    </optgroup>
   </select>
   </td>
   <td class="data"><span class="required">Required for all entires</span><span class="icon"><img src="images/information.png" /></span><a id="modal_window_link" href="output/styles.php">View Accepted Styles</a></td>
</tr>
</table>
<table>
<tr>
...
<tr>
   <td class="dataLabel" colspan="2"><input type="text" <?php if ($msg == "1") echo "style=\"border: 1px solid #FF0000\""; ?>  name="brewInfo" size="75"><?php if ($action == "edit") echo $row_log['brewInfo']; ?></textarea></td>
</tr>
</table>
<table>
<tr>
