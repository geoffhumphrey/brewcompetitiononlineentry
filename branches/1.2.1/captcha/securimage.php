...
class Securimage {
	 ...
	 * @var string
	 */
	var $background_directory = './backgrounds'; //'./backgrounds';
	...
	*/
	...
	function Securimage()
	{
		...
		$this->multi_text_color = array(new Securimage_Color(0xff, 0x20, 0xCC),
																		new Securimage_Color(0xff, 0x30, 0xEE),
																		new Securimage_color(0xff, 0x40, 0xCC),
																		new Securimage_Color(0xff, 0x50, 0xEE),
																		new Securimage_Color(0xff, 0x60, 0xCC));
		...
		$this->num_lines            = 20;
		$this->line_color           = new Securimage_Color(0x66, 0x66, 0x66);
		$this->draw_lines_over_text = false;

		$this->image_signature = '';
		$this->signature_color = new Securimage_Color(0x00, 0x00, 0x00);
