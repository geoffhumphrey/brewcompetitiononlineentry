	...
	<div class="menus">
		...
		<div class="toggle_container">
            ...
            <ul class="admin_default">
				...
				<li><a id="modal_window_link" href="output/sorting.php?section=admin&amp;go=default&amp;filter=default&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800">All Categories</a></li>
                <li>For Category:</li>
            ...
            <ul class="admin_default">
				...
				<li><a id="modal_window_link" href="output/sorting.php?section=admin&amp;go=cheat&amp;filter=default&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800">All Categories</a></li>
                <li>For Category:</li>
...
<p class="admin_default_header">Before Judging</p>
	...
	<li>Print Pullsheets:</li>
				<li><a id="modal_window_link" href="output/pullsheets.php?section=admin&amp;go=judging_tables&amp;id=default&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print All Table Pullsheets">All Tables</a></li>
				<li>
    <div class="menuBar"><a class="menuButton" href="#" onclick="#" onmouseover="buttonMouseover(event, 'pullsheets');">For Table #...</a></div>
    	<div id="pullsheets" class="menu" onmouseover="menuMouseover(event)">
			...
			<ul class="admin_default">
				...
				<li><a id="modal_window_link" href="output/table_cards.php?section=admin&amp;go=judging_tables&amp;id=default&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Pullsheets by Table">All Tables</a></li>
				<li>
    <div class="menuBar"><a class="menuButton" href="#" onclick="#" onmouseover="buttonMouseover(event, 'table_cards');">For Table #...</a></div>
    	<div id="table_cards" class="menu" onmouseover="menuMouseover(event)">
			...
			<ul class="admin_default">
				...
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=judges&amp;view=name&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Judge Assignments by Name">By Judge Last Name</a></li>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=judges&amp;view=table&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Judge Assignments by Table">By Table</a></li>
    <?php if ($totalRows_judging > 1) { ?>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=judges&amp;view=location&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Judge Assignments by Location">By Location</a></li>
    <?php } ?>
			</ul>
			<ul class="admin_default">
				<li>Print Steward Assignments:</li>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=stewards&amp;view=name&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Steward Assignments by Name">By Steward Last Name</a></li>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=stewards&amp;view=table&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Steward Assignments by Table">By Table</a></li>
    <?php if ($totalRows_judging > 1) { ?>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=stewards&amp;view=location&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print Steward Assignments by Location">By Location</a></li>
	<?php } ?>
			</ul>
			<ul class="admin_default">
				<li>Print Sign-in Sheets:</li>
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=judges&amp;view=sign-in&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print a Judge Sign-in Sheet">Judges</a></li>   
				<li><a id="modal_window_link" href="output/assignments.php?section=admin&amp;go=judging_assignments&amp;filter=stewards&amp;view=sign-in&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print a Steward Sign-in Sheet">Stewards</a></li>   
			</ul>
            <ul class="admin_default">
...
<p class="admin_default_header">During Judging</p>
			<ul class="admin_default">
    			...
    			<ul>
        			<li><a id="modal_window_link" href="output/pullsheets.php?section=admin&amp;go=judging_scores_bos&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="Print All BOS Pullsheets">All</a></li>
    	  <?php do { ?>
          <?php if ($row_style_type['styleTypeBOS'] == "Y") { ?><li><a id="modal_window_link" href="output/pullsheets.php?section=admin&amp;go=judging_scores_bos&amp;id=<?php echo $row_style_type['id']; ?>&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800"  title="Print the <?php echo $row_style_type['styleTypeName']; ?> BOS Pullsheet"><?php echo $row_style_type['styleTypeName']; ?></a></li><?php } ?>
          <?php } while ($row_style_type = mysql_fetch_assoc($style_type)) ?>
			...
			<ul class="admin_default">
				...
				<li><a id="modal_window_link" href="output/staff_points.php?section=admin&amp;go=judging_assignments&amp;action=download&amp;filter=default&amp;view=default&amp;KeepThis=true&amp;TB_iframe=true&amp;height=450&amp;width=800" title="BJCP Judge/Steward/Staff Points Report">Print</a></li>
