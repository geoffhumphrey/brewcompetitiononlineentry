...
<tbody>
 ...
 <tr>
  ...
  <?php if ($row_prefs['prefsDisplayWinners'] == "Y") echo score_check($row_log['id'],$scores_db_table);
    ...
    <td class="dataList"><?php if ($row_prefs['prefsDisplayWinners'] == "Y") { if ($action == "print") echo winner_check($row_log['id'],$scores_db_table,$tables_db_table,1); else echo winner_check($row_log['id'],$scores_db_table,$tables_db_table,2); } else echo "&nbsp;"; ?>
    </td>
    <?php } if ($action != "print") { ?>
    <?php if (judging_date_return() > 0) { ?>
  <td class="dataList">
