...
if ($action != "print") { 
?>
<p><span class="icon"><img src="images/printer.png"  border="0" alt="Print" /></span><a id="modal_window_link" href="output/print.php?section=<?php echo $section; ?>&amp;dbTable=<?php echo $dbTable; ?>&amp;action=print">Print This Page</a></p>
<?php }  
if ($totalRows_archive > 0) { ?>
	<p><span class="icon"><img src="images/award_star_gold_2.png"  /></span><span class="data">View past winners: <?php 
	do { 
