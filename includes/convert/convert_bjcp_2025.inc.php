...
$query_style_ids = sprintf("SELECT id, brewStyleGroup, brewStyleNum, brewStyleVersion FROM %s WHERE brewStyleVersion='BJCP2021' OR brewStyleVersion='BJCP2025' ORDER BY brewStyleVersion, id ASC", $styles_db_table);
...
$query_styles_active = sprintf("SELECT * FROM %s WHERE brewStyleVersion='BJCP2021' AND brewStyleActive='Y'", $styles_db_table);
