...
switch($section) {
	...
	if ($action == "add") $header_output = "Add an Entry"; 
		...
		switch ($msg) {
			...
			case "1-27-B":
			case "1-27-C": 
			case "1-27-D": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MAY specify variety of apple for a single varietal cider; if specified, varietal character will be expected."; break;
			case "1-27-E": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). Variety of pear(s) used MUST be stated."; break;
			case "1-28-A": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MUST specify if the cider was barrel-fermented or aged."; break;
			case "1-28-B": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet). You MUST specify what fruit(s) and/or fruit juice(s) were added."; break;
			case "1-28-C": $output = "See the area(s) highlighted in RED below. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet)."; break;
			case "1-28-D": $output = "See the area(s) highlighted in RED below. You MUST specify all major ingredients and adjuncts. You MUST specify carbonation level (still, petillant, or sparkling) AND sweetness (dry, medium, sweet)."; break;
			case "2": $output = "Info edited successfully."; break;
			case "3": $output = "There was an error. Please try again."; break;
			case "4": $output = "This competition utilizes custom entry categories. All custom entry categories require that you specify the special ingredients, classic style, or special procedures of the entry.<br>If you DO NOT specify these items, your entry cannot be confirmed. Unconfirmed entries will be deleted from the system after 24 hours."; break;
			default: $output = ""; break;
		}
	if (strstr($msg,"1-")) $output .= "<br>If you DO NOT specify the special ingredients, etc. listed above, your entry cannot be confirmed. Unconfirmed entries will be deleted from the system after 24 hours.";
	break;
