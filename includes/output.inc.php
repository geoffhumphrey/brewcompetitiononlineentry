...
$print_sections = ["admin", "assignments", "bos-mat", "dropoff", "summary", "particpant-entries", "inventory", "pullsheets", "results", "sorting", "staff", "table-cards", "notes", "styles", "shipping-label", "evaluation", "contact"];
$export_sections = ["export-entries", "export-loc", "export-emails", "export-participants", "export-promo", "export-results", "export-staff", "export-personal-results"];
$label_sections = ["labels-admin","labels-participant","labels-judge"];
$entry_sections = ["entry-form","entry-form-multi"];
$scoresheet_sections = ["scoresheet"];
