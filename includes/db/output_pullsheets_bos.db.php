...
if ($type == 4) $query_bos = sprintf("SELECT b.id, a.eid, a.scorePlace, a.scoreTable, a.scoreEntry, a.scorePlace, a.scoreType, a.scoreMiniBOS, c.brewerProAm, b.brewJudgingNumber, b.brewCategory, b.brewCategorySort, b.brewSubCategory, b.brewStyle, b.brewInfo, b.brewMead1, b.brewMead2, b.brewMead3, b.brewComments, b.brewInfoOptional, b.brewBrewerID, b.brewBoxNum, b.brewPossAllergens, b.brewStaffNotes FROM %s a, %s b, %s c WHERE a.eid = b.id AND c.uid = b.brewBrewerID AND (a.scoreType='%s' OR a.scoreType='%s')", $prefix."judging_scores", $prefix."brewing", $prefix."brewer", "2", "3");
