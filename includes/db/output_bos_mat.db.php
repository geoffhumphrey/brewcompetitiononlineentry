...
// Beer Styles
$query_scores = sprintf("SELECT b.id, a.scorePlace, b.brewJudgingNumber, b.brewCategory, b.brewCategorySort, b.brewSubCategory, b.brewStyle, b.brewInfo, b.brewMead1, b.brewMead2, b.brewMead3 FROM %s a, %s b, %s c WHERE a.eid = b.id AND c.uid = b.brewBrewerID AND a.scoreType='%s'", $judging_scores_db_table, $brewing_db_table, $brewer_db_table, $type);
