...
$query_spec_beer = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Beer' OR brewStyleType='1') AND brewStyleReqSpec='1' AND brewStyleCarb = '0' AND brewStyleStrength = '0' AND brewStyleSweet = '0'", $styles_db_table, $_SESSION['prefsStyleSet'], $styles_db_table);
...
$query_spec_all = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider' OR brewStyleType='2' OR brewStyleType='3') AND brewStyleStrength='1' AND brewStyleCarb='1' AND brewStyleReqSpec='1' AND brewStyleSweet='1'", $styles_db_table, $_SESSION['prefsStyleSet']);
...
$query_spec_sweet_carb = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider' OR brewStyleType ='2' OR brewStyleType ='3') AND brewStyleReqSpec='1' AND brewStyleStrength='0' AND brewStyleCarb='1' AND brewStyleSweet='1'", $styles_db_table, $_SESSION['prefsStyleSet']);
...
$query_spec_carb = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider' OR brewStyleType ='2' OR brewStyleType ='3') AND brewStyleReqSpec='1' AND brewStyleStrength='0' AND brewStyleCarb='1' AND brewStyleSweet='0'", $styles_db_table, $_SESSION['prefsStyleSet']);
