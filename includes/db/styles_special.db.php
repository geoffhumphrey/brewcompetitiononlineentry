...
$replacement3 = array('Entry Instructions:','Commercial Examples:','<strong><u>MUST</u></strong> specify','<strong><u>MAY</u></strong> specify (using the <em>Brewer&rsquo;s Specifics</em> field below)','<strong><u>MUST</u></strong> specify','<strong><u>MAY</u></strong> specify (using the <em>Brewer&rsquo;s Specifics</em> field below)','<strong><u>MUST</u></strong> provide','<strong><u>MUST</u></strong> be specified','<strong><u>MUST</u></strong> declare','<strong><u>MUST</u></strong> either','<strong><u>MUST</u></strong> supply','<strong><u>MAY</u></strong> provide (using the <em>Brewer&rsquo;s Specifics</em> field below)','<strong><u>MUST</u></strong> state');
...
$query_spec_beer = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND brewStyleGroup <='%s' AND brewStyleReqSpec='1'", $styles_db_table, $_SESSION['prefsStyleSet'],$beer_end);
...
$query_spec_all = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider') AND brewStyleStrength='1' AND brewStyleCarb='1' AND brewStyleReqSpec='1' AND brewStyleSweet='1'", $styles_db_table, $_SESSION['prefsStyleSet']);
...
$query_spec_sweet_carb = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider' OR brewStyleType >='2') AND brewStyleReqSpec='1' AND brewStyleStrength='0' AND brewStyleCarb='1' AND brewStyleSweet='1'", $styles_db_table, $_SESSION['prefsStyleSet']);
...
$query_spec_carb = sprintf("SELECT * FROM %s WHERE brewStyleVersion='%s' AND (brewStyleType='Mead' OR brewStyleType='Cider' OR brewStyleType >='2') AND brewStyleReqSpec='1' AND brewStyleStrength='0' AND brewStyleCarb='1' AND brewStyleSweet='0'", $styles_db_table, $_SESSION['prefsStyleSet']);
