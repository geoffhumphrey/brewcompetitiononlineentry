...
<div class="adminSubNavContainer">
   	...
   	<span class="adminSubNav">
    	<span class="icon"><img src="images/picture_add.png"  /></span><a href="admin/upload.admin.php?KeepThis=true&amp;TB_iframe=true&amp;height=600&amp;width=800" title="Upload Sponsor Logo Image" class="data thickbox"><?php if (($action == "add") || ($action == "edit")) echo "Upload the Sponsor's Logo Image"; else echo "Upload a Sponsor Logo Image"; ?></a>
	</span>
</div>
...
<table class="dataTable" id="sortable">
 ...
 <tr>
  ...
  <td width="5%" class="dataList"><a href="<?php echo $row_sponsors['sponsorURL']; ?>?KeepThis=true&amp;TB_iframe=true&amp;height=600&amp;width=800" class="thickbox"><?php echo $row_sponsors['sponsorURL']; ?></a></td>
...
<table>
  ...
  <tr>
    ...
    <td class="data">Be sure to enter the <em>exact name</em> of the file (e.g., sponsor_logo.jpg) that has been <a href="admin/upload.admin.php?KeepThis=true&amp;TB_iframe=true&amp;height=600&amp;width=800" title="Upload Sponsor Logo Image" class="thickbox">uploaded</a>.</td>
  </tr>
  <tr>
