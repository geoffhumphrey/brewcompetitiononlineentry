...
<div class="bcoem-admin-element hidden-print">
        ...
        <a class="btn btn-<?php if ($go == "hero_images") echo "primary disabled"; else echo "primary"; ?>" style="margin: 5px 5px 5px 0" href="<?php echo $base_url; ?>index.php?section=admin&amp;go=hero_images"><span class="fa fa-image"></span> Banner Images</a>
