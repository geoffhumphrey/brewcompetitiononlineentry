...
<tr>
    ...
    <?php if ($action != "default") { ?><td class="dataList" width="5%" nowrap="nowrap"><span class="icon"><img src="images/arrow_left.png" alt="Back"></span><a class="data" href="index.php?section=admin&amp;go=judging_scores">Back to Scores List</a></td></td>
    <?php } ?>
...
<tbody>
	<tr>
    	<td colspan="2">Scores have been entered for <?php echo $totalRows_scores; ?> of <?php echo $totalRows_entry_count; ?> entries marked as paid and received.</td>
    </tr>
    <tr>
    	<td width="5%" nowrap="nowrap"><em>All</em> scores have not been entered for table(s):</td>
        <td class="data">
...
<tbody>
	...
	$style = $row_entries_1['brewCategory'].$row_entries_1['brewSubCategory'];
