...
<?
if ($totalRows_judging == 0) echo "<p>No judging sessions have been defined. <a href=\"".$base_url."index.php?section=admin&amp;go=judging&amp;action=add\">Add a judging session</a>?</p>"; 
else { 
