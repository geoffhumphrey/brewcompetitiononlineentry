...
<p><?php if ($bid == "default") echo "Choose ".$filter." to assign.";  else echo "Check below which ".$filter." will be assigned to the ".h($row_dropoff['dropLocationName']). " location."; ?></p>
<?php }?>
...
<div class="form-group"><!-- Form Group REQUIRED Text Input -->
	...
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
		<div class="input-group has-warning">
			<!-- Input Here -->
			<input class="form-control" id="dropLocationName" name="dropLocationName" type="text" value="<?php if ($action == "edit") echo h($row_dropoff['dropLocationName']); ?>" data-error="The dropoff location's name is required" placeholder="" autofocus required>
...
<div class="form-group"><!-- Form Group REQUIRED Text Input -->
	...
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
		<div class="input-group has-warning">
			<!-- Input Here -->
			<input class="form-control" id="dropLocationPhone" name="dropLocationPhone" type="tel" value="<?php if ($action == "edit") echo h($row_dropoff['dropLocationPhone']); ?>" data-error="The dropoff location's phone number is required" placeholder="" required>
...
<div class="form-group"><!-- Form Group REQUIRED Text Input -->
	...
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
		<div class="input-group has-warning">
			<!-- Input Here -->
			<input class="form-control" id="dropLocation" name="dropLocation" type="text" value="<?php if ($action == "edit") echo h($row_dropoff['dropLocation']); ?>" data-error="The dropoff location's address is required" placeholder="" maxlength="255" required>
...
<div class="form-group">
	...
	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
		<input class="form-control" id="dropLocationWNotes" name="dropLocationNotes" type="text" value="<?php if ($action == "edit") echo h($row_dropoff['dropLocationNotes']); ?>" placeholder="" maxlength="255">
...
<tbody>
 ...
 ?>
 <tr>
	<td><?php echo h($row_dropoff['dropLocationName']); ?></td>
	<td nowrap><?php echo h($phone); ?></td>
	<td><?php echo h($row_dropoff['dropLocation']); ?></td>
	<td><?php echo h($row_dropoff['dropLocationNotes']); ?></td>
	<td>
		<a href="<?php echo $base_url; ?>index.php?section=admin&amp;go=<?php echo $go; ?>&amp;action=edit&amp;id=<?php echo $row_dropoff['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit <?php echo h($row_dropoff['dropLocationName']); ?>"><span class="fa fa-lg fa-pencil"></span></a>
		<a class="hide-loader" href="<?php echo $base_url; ?>includes/process.inc.php?section=admin&amp;go=<?php echo $go; ?>&amp;dbTable=<?php echo $drop_off_db_table; ?>&amp;action=delete&amp;id=<?php echo $row_dropoff['id']; ?>" data-toggle="tooltip" data-placement="top" title="Delete <?php echo h($row_dropoff['dropLocationName']); ?>" data-confirm="Are you sure you want to delete the <?php echo h($row_dropoff['dropLocationName']); ?> location? This cannot be undone."><span class="fa fa-lg fa-trash-o"></span></a>
		<?php if (($row_dropoff['dropLocationWebsite'] != "") && (preg_match('#^https?://#i', $row_dropoff['dropLocationWebsite']))) echo "<a class=\"hide-loader\" href=\"".h($row_dropoff['dropLocationWebsite'])."\" target=\"_blank\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Visit the ".h($row_dropoff['dropLocationName'])." website\"><span class=\"fa fa-lg fa-link\"></span></a> "; ?>
	</tr>
  <?php } ?>
</tbody>
</table>
