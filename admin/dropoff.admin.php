...
<p><span class="icon"><img src="<?php echo $base_url."images/tick.png"; ?>" /></span><a href="<?php if ($section == "step6") echo "setup.php?section=step6"; else echo "index.php?section=admin&amp;go=dropoff"; ?>">Yes</a>&nbsp;&nbsp;&nbsp;<span class="icon"><img src="<?php echo $base_url."images/cross.png"; ?>" /></span><a href="<?php if ($section == "step6") echo "setup.php?section=step7"; else echo "index.php?section=admin"; ?>">No</a>
<?php } else { ?>
