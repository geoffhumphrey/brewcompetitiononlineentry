...
<tbody>
 ...
 <tr>
  <!-- contactFirstName/contactLastName/contactPosition are already HTML-entity-encoded
       at save time (process_contacts.inc.php's sterilize()) - h() here would
       double-encode them. contactEmail below isn't pre-encoded the same way, so it
       still needs h(). -->
