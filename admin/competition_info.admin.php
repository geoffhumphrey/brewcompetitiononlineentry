...
<div class="form-group"><!-- Form Group NOT REQUIRED Text Input -->
    ...
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    	<div class="input-group">
        	...
        	<!-- Input Here -->
        	<input class="form-control" id="contestEntryCap" name="contestEntryCap" type="number" maxlength="5" step=".01" value="<?php if ($section != "step4") echo number_format($row_contest_info['contestEntryCap'],2); ?>" placeholder="">
        </div>
...
<div class="form-group"><!-- Form Group NOT REQUIRED Text Input -->
    ...
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    	<div class="input-group">
        	...
        	<!-- Input Here -->
        	<input class="form-control" id="contestEntryFee2" name="contestEntryFee2" type="number" maxlength="5" step=".01" value="<?php if ($section != "step4") echo number_format($row_contest_info['contestEntryFee2'],2); ?>" placeholder="">
        </div>
...
<div class="form-group"><!-- Form Group NOT REQUIRED Text Input -->
    ...
    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-12">
    	<div class="input-group">
        	...
        	<!-- Input Here -->
        	<input class="form-control" id="contestEntryFeePasswordNum" name="contestEntryFeePasswordNum" type="number" maxlength="5" step=".01" value="<?php if ($section != "step4") echo number_format($row_contest_info['contestEntryFeePasswordNum'],2); ?>" placeholder="">
        </div>
