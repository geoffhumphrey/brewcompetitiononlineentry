...
<thead>
 ...
 <tr<?php if (($row_log['brewConfirmed'] == "0") && ($action != "print")) echo " style='background-color: #ff9; border-top: 1px solid #F90; border-bottom: 1px solid #F90;'"; elseif ((check_special_ingredients($entry_style)) && ($row_log['brewInfo'] == "")) echo " style='background-color: #ff9; border-top: 1px solid #F90; border-bottom: 1px solid #F90;'"; ?>>
  ...
  <td nowrap="nowrap" class="dataList "><?php if (($action != "print") && ($dbTable == "default")) { ?><input id="brewPaid" name="brewPaid<?php echo $row_log['id']; ?>" type="checkbox" value="1" <?php if ($row_log['brewPaid'] == "1") echo "checked"; else ""; ?> /><?php echo "<span style='visibility:hidden'>".$row_log['brewPaid']."</span>"; if ($brewer_info[9] == "Y") echo "&nbsp;<span class='icon'><img src='".$base_url."images/star.png' title='Redeemed Discount Code'></span>"; } else { if ($row_log['brewPaid'] == "1") echo "&#10003;"; } ?></td>
  <td class="dataList "><?php if (($action != "print") && ($dbTable == "default")) { ?><input id="brewReceived" name="brewReceived<?php echo $row_log['id']; ?>" type="checkbox" value="1" <?php if ($row_log['brewReceived'] == "1") echo "checked"; else ""; ?> /><?php  echo "<span style='visibility:hidden'>".$row_log['brewReceived']."</span>"; } else { if ($row_log['brewReceived'] == "1") echo "&#10003;"; } ?></td>
