...
--
-- Sets up a basic install and baseline data for version 1.3.0.X.
...
-- - Password: bcoem
-- - Security question: What is your favorite all-time beer to 
--   drink?
-- - Answer: pabst
...
--
-- Dumping data for table `baseline_archive`
--
...
--
-- Dumping data for table `baseline_brewing`
--
...
--
-- Dumping data for table `baseline_judging_assignments`
--
...
--
-- Dumping data for table `baseline_judging_flights`
--
...
(1, '1378535400', NULL, 'Sample Location', '1234 Main Street, Anytown, CO 80111', 2);
...
--
-- Dumping data for table `baseline_judging_scores`
--
...
--
-- Dumping data for table `baseline_judging_scores_bos`
--
...
--
-- Dumping data for table `baseline_judging_tables`
--
...
--
-- Dumping data for table `baseline_mods`
--
...
--
-- Dumping data for table `baseline_special_best_data`
--
...
--
-- Dumping data for table `baseline_special_best_info`
--
...
--
-- Dumping data for table `baseline_sponsors`
--
...
--
-- Dumping data for table `baseline_staff`
--
...
(1, '1.3.0.3', '2012-10-25', '2013-09-13 11:59:59', 1);
...
(1, 'user.baseline@brewcompetition.com', '$2a$08$s4XveVAjK.VKmnPrcYRXvuPcwjRH1lOpwvOyxFXBy6qW9hBzb39te', '0', 'What is your favorite all-time beer to drink?', 'pabst', '2013-08-26 07:47:36');
